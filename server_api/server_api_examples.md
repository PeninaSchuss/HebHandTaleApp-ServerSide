## Examples of calling the functions found in the server_api.py file using Windows PowerShell (but can also be done in other ways too - through chrome, postman, etc.):
